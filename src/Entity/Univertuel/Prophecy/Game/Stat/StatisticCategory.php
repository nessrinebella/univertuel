...
use App\Repository\Univertuel\Prophecy\Game\Stat\StatisticCategoryRepository;
use Doctrine\ORM\Mapping as ORM;
use App\Entity\Univertuel\Game\Game;

/**
 * @ORM\Entity(repositoryClass=StatisticCategoryRepository::class)
 * @ORM\Table(name="prophecy_statistic_category")
 */
